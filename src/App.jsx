...
function App() {
  ...
  function handleChange(e) {
    setCantidad(+e.target.value) //+e es igual a Number() o parseInt()
  }
    ...
    <>
      <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
          ...
          <div className="my-5 space-y-3 bg-gray-50 p-5">
            ...
            <p className="text-xl text-gray-500 text-center font-bold">Mensualidades de {formatearDinero(pago)}  </p>
          </div>
      </div>
    </>
  )
